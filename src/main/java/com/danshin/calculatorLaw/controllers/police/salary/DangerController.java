...
@RestController
@RequestMapping("/police/salary/dangers")
public record DangerController(DangerService service) {
    @GetMapping
    public ResponseEntity<List<DangerDto>> getAll(
    ...
    @GetMapping("/id")
    public ResponseEntity<List<DangerDto>> getById(
