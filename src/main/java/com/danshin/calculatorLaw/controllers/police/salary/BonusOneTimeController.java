...
@RestController
@RequestMapping("/police/salary/bonus-one-times")
public record BonusOneTimeController(BonusOneTimeService service) {
    @GetMapping
    public ResponseEntity<List<BonusOneTimeDto>> getAll(
    ...
    @GetMapping("/id")
    public ResponseEntity<List<BonusOneTimeDto>> getById(
