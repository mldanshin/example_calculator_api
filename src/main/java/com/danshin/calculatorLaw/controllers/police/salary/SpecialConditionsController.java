...
@RestController
@RequestMapping("/police/salary/special-conditions")
public record SpecialConditionsController(SpecialConditionsService service) {
    @GetMapping
    public ResponseEntity<List<SpecialConditionsDto>> getAll(
    ...
    @GetMapping("/id")
    public ResponseEntity<List<SpecialConditionsDto>> getById(
